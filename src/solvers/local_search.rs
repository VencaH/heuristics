...
{
    pub fn new(max_local_iter: i32, problem: T) -> Self {
        LocalSearch {
            max_local_iter,
            curren_best: None,
    ...
    pub fn run(&mut self) -> () {
        ...
        loop {
            ...
            current_best_coords = local_best_coords;
...
mod test {
    ...
    fn run() {
        ...
        let mut random_search = LocalSearch::new(10, mocked_problem);
        random_search.run();
        assert_ne!(random_search.cost_history.len(), 0);
    }
